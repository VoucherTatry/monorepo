...
export type AdvancedSection = {
  ...
  localizations: Array<AdvancedSection>;
  /** System stage field */
  stage: Stage;
...
export type AdvancedSectionLocalizationsArgs = {
  includeCurrent?: Scalars['Boolean'];
  locales?: Array<Locale>;
};

export type AdvancedSectionConnectInput = {
  /** Allow to specify document position in list of connected documents, will default to appending at end of list */
  position?: InputMaybe<ConnectPositionInput>;
  /** Document to connect */
  where: AdvancedSectionWhereUniqueInput;
};

/** A connection to a list of items. */
export type AdvancedSectionConnection = {
  __typename?: 'AdvancedSectionConnection';
  aggregate: Aggregate;
  /** A list of edges. */
  edges: Array<AdvancedSectionEdge>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
};

export type AdvancedSectionCreateInput = {
  /** description input for default locale (pl) */
  description: Scalars['RichTextAST'];
  /** Inline mutations for managing document localizations excluding the default locale */
  localizations?: InputMaybe<AdvancedSectionCreateLocalizationsInput>;
  /** title input for default locale (pl) */
  title: Scalars['String'];
};

export type AdvancedSectionCreateLocalizationDataInput = {
  description: Scalars['RichTextAST'];
  title: Scalars['String'];
};

export type AdvancedSectionCreateLocalizationInput = {
  /** Localization input */
  data: AdvancedSectionCreateLocalizationDataInput;
  locale: Locale;
};

export type AdvancedSectionCreateLocalizationsInput = {
  /** Create localizations for the newly-created document */
  create?: InputMaybe<Array<AdvancedSectionCreateLocalizationInput>>;
};

export type AdvancedSectionCreateManyInlineInput = {
  /** Create and connect multiple existing AdvancedSection documents */
  create?: InputMaybe<Array<AdvancedSectionCreateInput>>;
};

export type AdvancedSectionCreateOneInlineInput = {
  /** Create and connect one AdvancedSection document */
  create?: InputMaybe<AdvancedSectionCreateInput>;
};

export type AdvancedSectionCreateWithPositionInput = {
  /** Document to create */
  data: AdvancedSectionCreateInput;
  /** Position in the list of existing component instances, will default to appending at the end of list */
  position?: InputMaybe<ConnectPositionInput>;
};

/** An edge in a connection. */
export type AdvancedSectionEdge = {
  __typename?: 'AdvancedSectionEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String'];
  /** The item at the end of the edge. */
  node: AdvancedSection;
};

/** Identifies documents */
export type AdvancedSectionManyWhereInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<AdvancedSectionWhereInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<AdvancedSectionWhereInput>>;
  /** Logical OR on all given filters. */
  OR?: InputMaybe<Array<AdvancedSectionWhereInput>>;
...
export enum AdvancedSectionOrderByInput {
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
  TitleAsc = 'title_ASC',
...
export type AdvancedSectionParent = Page;

export type AdvancedSectionParentConnectInput = {
  Page?: InputMaybe<PageConnectInput>;
};

export type AdvancedSectionParentCreateInput = {
  Page?: InputMaybe<PageCreateInput>;
};

export type AdvancedSectionParentCreateManyInlineInput = {
  /** Connect multiple existing AdvancedSectionParent documents */
  connect?: InputMaybe<Array<AdvancedSectionParentWhereUniqueInput>>;
  /** Create and connect multiple existing AdvancedSectionParent documents */
  create?: InputMaybe<Array<AdvancedSectionParentCreateInput>>;
};

export type AdvancedSectionParentCreateOneInlineInput = {
  /** Connect one existing AdvancedSectionParent document */
  connect?: InputMaybe<AdvancedSectionParentWhereUniqueInput>;
  /** Create and connect one AdvancedSectionParent document */
  create?: InputMaybe<AdvancedSectionParentCreateInput>;
};

export type AdvancedSectionParentUpdateInput = {
  Page?: InputMaybe<PageUpdateInput>;
};

export type AdvancedSectionParentUpdateManyInlineInput = {
  /** Connect multiple existing AdvancedSectionParent documents */
  connect?: InputMaybe<Array<AdvancedSectionParentConnectInput>>;
  /** Create and connect multiple AdvancedSectionParent documents */
  create?: InputMaybe<Array<AdvancedSectionParentCreateInput>>;
  /** Delete multiple AdvancedSectionParent documents */
  delete?: InputMaybe<Array<AdvancedSectionParentWhereUniqueInput>>;
  /** Disconnect multiple AdvancedSectionParent documents */
  disconnect?: InputMaybe<Array<AdvancedSectionParentWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing AdvancedSectionParent documents */
  set?: InputMaybe<Array<AdvancedSectionParentWhereUniqueInput>>;
  /** Update multiple AdvancedSectionParent documents */
  update?: InputMaybe<Array<AdvancedSectionParentUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple AdvancedSectionParent documents */
  upsert?: InputMaybe<Array<AdvancedSectionParentUpsertWithNestedWhereUniqueInput>>;
};

export type AdvancedSectionParentUpdateManyWithNestedWhereInput = {
  Page?: InputMaybe<PageUpdateManyWithNestedWhereInput>;
};

export type AdvancedSectionParentUpdateOneInlineInput = {
  /** Connect existing AdvancedSectionParent document */
  connect?: InputMaybe<AdvancedSectionParentWhereUniqueInput>;
  /** Create and connect one AdvancedSectionParent document */
  create?: InputMaybe<AdvancedSectionParentCreateInput>;
  /** Delete currently connected AdvancedSectionParent document */
  delete?: InputMaybe<Scalars['Boolean']>;
  /** Disconnect currently connected AdvancedSectionParent document */
  disconnect?: InputMaybe<Scalars['Boolean']>;
  /** Update single AdvancedSectionParent document */
  update?: InputMaybe<AdvancedSectionParentUpdateWithNestedWhereUniqueInput>;
  /** Upsert single AdvancedSectionParent document */
  upsert?: InputMaybe<AdvancedSectionParentUpsertWithNestedWhereUniqueInput>;
};

export type AdvancedSectionParentUpdateWithNestedWhereUniqueInput = {
  Page?: InputMaybe<PageUpdateWithNestedWhereUniqueInput>;
};

export type AdvancedSectionParentUpsertWithNestedWhereUniqueInput = {
  Page?: InputMaybe<PageUpsertWithNestedWhereUniqueInput>;
};

export type AdvancedSectionParentWhereInput = {
  Page?: InputMaybe<PageWhereInput>;
};

export type AdvancedSectionParentWhereUniqueInput = {
  Page?: InputMaybe<PageWhereUniqueInput>;
};

export type AdvancedSectionUpdateInput = {
  /** description input for default locale (pl) */
  description?: InputMaybe<Scalars['RichTextAST']>;
  /** Manage document localizations */
  localizations?: InputMaybe<AdvancedSectionUpdateLocalizationsInput>;
  /** title input for default locale (pl) */
  title?: InputMaybe<Scalars['String']>;
};

export type AdvancedSectionUpdateLocalizationDataInput = {
  description?: InputMaybe<Scalars['RichTextAST']>;
  title?: InputMaybe<Scalars['String']>;
};

export type AdvancedSectionUpdateLocalizationInput = {
  data: AdvancedSectionUpdateLocalizationDataInput;
  locale: Locale;
};

export type AdvancedSectionUpdateLocalizationsInput = {
  /** Localizations to create */
  create?: InputMaybe<Array<AdvancedSectionCreateLocalizationInput>>;
  /** Localizations to delete */
  delete?: InputMaybe<Array<Locale>>;
  /** Localizations to update */
  update?: InputMaybe<Array<AdvancedSectionUpdateLocalizationInput>>;
  upsert?: InputMaybe<Array<AdvancedSectionUpsertLocalizationInput>>;
};

export type AdvancedSectionUpdateManyInlineInput = {
  /** Create and connect multiple AdvancedSection component instances */
  create?: InputMaybe<Array<AdvancedSectionCreateWithPositionInput>>;
  /** Delete multiple AdvancedSection documents */
  delete?: InputMaybe<Array<AdvancedSectionWhereUniqueInput>>;
  /** Update multiple AdvancedSection component instances */
  update?: InputMaybe<Array<AdvancedSectionUpdateWithNestedWhereUniqueAndPositionInput>>;
  /** Upsert multiple AdvancedSection component instances */
  upsert?: InputMaybe<Array<AdvancedSectionUpsertWithNestedWhereUniqueAndPositionInput>>;
};

export type AdvancedSectionUpdateManyInput = {
  /** description input for default locale (pl) */
  description?: InputMaybe<Scalars['RichTextAST']>;
  /** Optional updates to localizations */
  localizations?: InputMaybe<AdvancedSectionUpdateManyLocalizationsInput>;
};

export type AdvancedSectionUpdateManyLocalizationDataInput = {
  description?: InputMaybe<Scalars['RichTextAST']>;
};

export type AdvancedSectionUpdateManyLocalizationInput = {
  data: AdvancedSectionUpdateManyLocalizationDataInput;
  locale: Locale;
};

export type AdvancedSectionUpdateManyLocalizationsInput = {
  /** Localizations to update */
  update?: InputMaybe<Array<AdvancedSectionUpdateManyLocalizationInput>>;
};

export type AdvancedSectionUpdateManyWithNestedWhereInput = {
  /** Update many input */
  data: AdvancedSectionUpdateManyInput;
  /** Document search */
  where: AdvancedSectionWhereInput;
};

export type AdvancedSectionUpdateOneInlineInput = {
  /** Create and connect one AdvancedSection document */
  create?: InputMaybe<AdvancedSectionCreateInput>;
  /** Delete currently connected AdvancedSection document */
  delete?: InputMaybe<Scalars['Boolean']>;
  /** Update single AdvancedSection document */
  update?: InputMaybe<AdvancedSectionUpdateWithNestedWhereUniqueInput>;
  /** Upsert single AdvancedSection document */
  upsert?: InputMaybe<AdvancedSectionUpsertWithNestedWhereUniqueInput>;
};

export type AdvancedSectionUpdateWithNestedWhereUniqueAndPositionInput = {
  /** Document to update */
  data?: InputMaybe<AdvancedSectionUpdateInput>;
  /** Position in the list of existing component instances, will default to appending at the end of list */
  position?: InputMaybe<ConnectPositionInput>;
...
export type AdvancedSectionUpdateWithNestedWhereUniqueInput = {
  /** Document to update */
  data: AdvancedSectionUpdateInput;
  /** Unique document search */
  where: AdvancedSectionWhereUniqueInput;
};

export type AdvancedSectionUpsertInput = {
  /** Create document if it didn't exist */
  create: AdvancedSectionCreateInput;
  /** Update document if it exists */
  update: AdvancedSectionUpdateInput;
};

export type AdvancedSectionUpsertLocalizationInput = {
  create: AdvancedSectionCreateLocalizationDataInput;
  locale: Locale;
  update: AdvancedSectionUpdateLocalizationDataInput;
};

export type AdvancedSectionUpsertWithNestedWhereUniqueAndPositionInput = {
  /** Document to upsert */
  data?: InputMaybe<AdvancedSectionUpsertInput>;
  /** Position in the list of existing component instances, will default to appending at the end of list */
  position?: InputMaybe<ConnectPositionInput>;
  /** Unique component instance search */
  where: AdvancedSectionWhereUniqueInput;
...
export type AdvancedSectionUpsertWithNestedWhereUniqueInput = {
  /** Upsert data */
  data: AdvancedSectionUpsertInput;
  /** Unique document search */
  where: AdvancedSectionWhereUniqueInput;
};

/** Identifies documents */
export type AdvancedSectionWhereInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<AdvancedSectionWhereInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<AdvancedSectionWhereInput>>;
...
/** References AdvancedSection record uniquely */
export type AdvancedSectionWhereUniqueInput = {
  id?: InputMaybe<Scalars['ID']>;
};
...
export type AssetCreateInput = {
  ...
  zdjecieTilesSection?: InputMaybe<TileCreateManyInlineInput>;
};
...
export type AssetUpdateInput = {
  ...
  size?: InputMaybe<Scalars['Float']>;
  width?: InputMaybe<Scalars['Float']>;
  zdjecieTilesSection?: InputMaybe<TileUpdateManyInlineInput>;
};
...
export type BannerCreateInput = {
  /** button input for default locale (pl) */
  button?: InputMaybe<Scalars['String']>;
  /** Inline mutations for managing document localizations excluding the default locale */
  localizations?: InputMaybe<BannerCreateLocalizationsInput>;
  /** summary input for default locale (pl) */
  summary: Scalars['String'];
  /** text input for default locale (pl) */
  text: Scalars['String'];
};
...
export type BannerCreateWithPositionInput = {
  /** Document to create */
...
export type BannerParent = HomePage;

export type BannerParentConnectInput = {
  HomePage?: InputMaybe<HomePageConnectInput>;
};

export type BannerParentCreateInput = {
  HomePage?: InputMaybe<HomePageCreateInput>;
};

export type BannerParentCreateManyInlineInput = {
  /** Connect multiple existing BannerParent documents */
  connect?: InputMaybe<Array<BannerParentWhereUniqueInput>>;
  /** Create and connect multiple existing BannerParent documents */
  create?: InputMaybe<Array<BannerParentCreateInput>>;
};

export type BannerParentCreateOneInlineInput = {
...
export type BannerParentUpdateInput = {
  HomePage?: InputMaybe<HomePageUpdateInput>;
};

export type BannerParentUpdateManyInlineInput = {
  /** Connect multiple existing BannerParent documents */
  connect?: InputMaybe<Array<BannerParentConnectInput>>;
  /** Create and connect multiple BannerParent documents */
  create?: InputMaybe<Array<BannerParentCreateInput>>;
  /** Delete multiple BannerParent documents */
  delete?: InputMaybe<Array<BannerParentWhereUniqueInput>>;
  /** Disconnect multiple BannerParent documents */
  disconnect?: InputMaybe<Array<BannerParentWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing BannerParent documents */
  set?: InputMaybe<Array<BannerParentWhereUniqueInput>>;
  /** Update multiple BannerParent documents */
  update?: InputMaybe<Array<BannerParentUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple BannerParent documents */
  upsert?: InputMaybe<Array<BannerParentUpsertWithNestedWhereUniqueInput>>;
};

export type BannerParentUpdateManyWithNestedWhereInput = {
  HomePage?: InputMaybe<HomePageUpdateManyWithNestedWhereInput>;
};

export type BannerParentUpdateOneInlineInput = {
...
export type BannerParentUpdateWithNestedWhereUniqueInput = {
  HomePage?: InputMaybe<HomePageUpdateWithNestedWhereUniqueInput>;
};

export type BannerParentUpsertWithNestedWhereUniqueInput = {
  HomePage?: InputMaybe<HomePageUpsertWithNestedWhereUniqueInput>;
};

export type BannerParentWhereInput = {
  HomePage?: InputMaybe<HomePageWhereInput>;
};

export type BannerParentWhereUniqueInput = {
...
export type BannerUpdateManyInlineInput = {
  ...
  create?: InputMaybe<Array<BannerCreateWithPositionInput>>;
  /** Delete multiple Banner documents */
  delete?: InputMaybe<Array<BannerWhereUniqueInput>>;
  /** Update multiple Banner component instances */
  update?: InputMaybe<Array<BannerUpdateWithNestedWhereUniqueAndPositionInput>>;
  /** Upsert multiple Banner component instances */
  upsert?: InputMaybe<Array<BannerUpsertWithNestedWhereUniqueAndPositionInput>>;
};
...
export type BannerUpdateWithNestedWhereUniqueAndPositionInput = {
  /** Document to update */
...
export type BannerUpsertWithNestedWhereUniqueAndPositionInput = {
  /** Document to upsert */
...
/** Sekcja z atrakcjami - każda nowa strona odpowiada za nową kategorię */
export type Category = Node & {
  ...
  /** The unique identifier */
  id: Scalars['ID'];
  /** Przykładowy kafelek który będzie wyświetlany jako "placeholder" zanim skompletujemy atrakcje od prawdziwych klientów */
  kafelek?: Maybe<Tile>;
  /** System Locale field */
  locale: Locale;
  /** Get the other localizations for this document */
...
/** Sekcja z atrakcjami - każda nowa strona odpowiada za nową kategorię */
export type CategoryKafelekArgs = {
  locales?: InputMaybe<Array<Locale>>;
};
...
export type CategoryCreateInput = {
  cl3nd927h3qpu01z16t8h70sh?: InputMaybe<HomePageCreateManyInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  kafelek?: InputMaybe<TileCreateOneInlineInput>;
  /** Inline mutations for managing document localizations excluding the default locale */
...
export type CategoryManyWhereInput = {
  ...
  /** All values starting with the given string. */
  id_starts_with?: InputMaybe<Scalars['ID']>;
  kafelek?: InputMaybe<TileWhereInput>;
  publishedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  publishedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export type CategoryUpdateInput = {
  cl3nd927h3qpu01z16t8h70sh?: InputMaybe<HomePageUpdateManyInlineInput>;
  kafelek?: InputMaybe<TileUpdateOneInlineInput>;
  /** Manage document localizations */
...
export type HeroCreateInput = {
  /** ctaButtonLabel input for default locale (pl) */
  ctaButtonLabel: Scalars['String'];
  /** description input for default locale (pl) */
  description?: InputMaybe<Scalars['String']>;
  /** Inline mutations for managing document localizations excluding the default locale */
  localizations?: InputMaybe<HeroCreateLocalizationsInput>;
  /** titleFirstLine input for default locale (pl) */
  titleFirstLine: Scalars['String'];
  /** titleSecondLine input for default locale (pl) */
  titleSecondLine: Scalars['String'];
};
...
export enum HeroOrderByInput {
  ...
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
  TitleFirstLineAsc = 'titleFirstLine_ASC',
  TitleFirstLineDesc = 'titleFirstLine_DESC',
  TitleSecondLineAsc = 'titleSecondLine_ASC',
  TitleSecondLineDesc = 'titleSecondLine_DESC'
}
...
export type HeroWhereInput = {
  ...
  /** All values ending with the given string. */
  ctaButtonLabel_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  ...
  /** All values not ending with the given string */
  ctaButtonLabel_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  ctaButtonLabel_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values not starting with the given string. */
  ctaButtonLabel_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  ctaButtonLabel_starts_with?: InputMaybe<Scalars['String']>;
  description?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  ...
  titleFirstLine?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  titleFirstLine_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  titleFirstLine_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  titleFirstLine_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values that are not equal to given value. */
  titleFirstLine_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  titleFirstLine_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  titleFirstLine_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  titleFirstLine_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values not starting with the given string. */
  titleFirstLine_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  titleFirstLine_starts_with?: InputMaybe<Scalars['String']>;
  titleSecondLine?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  titleSecondLine_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  titleSecondLine_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  titleSecondLine_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values that are not equal to given value. */
  titleSecondLine_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  titleSecondLine_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  titleSecondLine_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  titleSecondLine_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values not starting with the given string. */
  titleSecondLine_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  titleSecondLine_starts_with?: InputMaybe<Scalars['String']>;
};
...
export type HomePageAboutSectionArgs = {
  locales?: InputMaybe<Array<Locale>>;
};
...
export type HomePageCreateInput = {
  aboutSection?: InputMaybe<SectionCreateOneInlineInput>;
...
export type HomePageManyWhereInput = {
  ...
  /** Contains search across all appropriate fields. */
  _search?: InputMaybe<Scalars['String']>;
  aboutSection?: InputMaybe<SectionWhereInput>;
...
export type HomePageUpdateInput = {
  aboutSection?: InputMaybe<SectionUpdateOneInlineInput>;
...
export type Page = Node & {
  ...
  publishedBy?: Maybe<User>;
  scheduledIn: Array<ScheduledOperation>;
  sections: Array<AdvancedSection>;
  /** System stage field */
  stage: Stage;
  /** The time the document was updated */
  updatedAt: Scalars['DateTime'];
...
export type PageSectionsArgs = {
  ...
  last?: InputMaybe<Scalars['Int']>;
  locales?: InputMaybe<Array<Locale>>;
  orderBy?: InputMaybe<AdvancedSectionOrderByInput>;
  skip?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<AdvancedSectionWhereInput>;
};
...
export type PageCreateInput = {
  ...
  /** pageTitle input for default locale (pl) */
  pageTitle: Scalars['String'];
  sections?: InputMaybe<AdvancedSectionCreateManyInlineInput>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
};
...
export type PageManyWhereInput = {
  ...
  scheduledIn_none?: InputMaybe<ScheduledOperationWhereInput>;
  scheduledIn_some?: InputMaybe<ScheduledOperationWhereInput>;
  sections_every?: InputMaybe<AdvancedSectionWhereInput>;
  sections_none?: InputMaybe<AdvancedSectionWhereInput>;
  sections_some?: InputMaybe<AdvancedSectionWhereInput>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  updatedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export type PageUpdateInput = {
  ...
  sections?: InputMaybe<AdvancedSectionUpdateManyInlineInput>;
};
...
export type PageWhereInput = {
  ...
  /** All values not ending with the given string */
  pageTitle_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  pageTitle_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values not starting with the given string. */
  pageTitle_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
...
export type ScheduledOperationAffectedDocument = Asset | Category | HomePage | Page;
...
export type SectionParent = HomePage;
...
export type TileLocalizationsArgs = {
  includeCurrent?: Scalars['Boolean'];
  locales?: Array<Locale>;
};


export type TilePhotoArgs = {
  locales?: InputMaybe<Array<Locale>>;
};
...
export type TileCreateInput = {
  /** Inline mutations for managing document localizations excluding the default locale */
  localizations?: InputMaybe<TileCreateLocalizationsInput>;
  photo: AssetCreateOneInlineInput;
  /** title input for default locale (pl) */
  title: Scalars['String'];
};

export type TileCreateLocalizationDataInput = {
  title: Scalars['String'];
};

export type TileCreateLocalizationInput = {
  /** Localization input */
  data: TileCreateLocalizationDataInput;
  locale: Locale;
};

export type TileCreateLocalizationsInput = {
  /** Create localizations for the newly-created document */
  create?: InputMaybe<Array<TileCreateLocalizationInput>>;
};
...
export type TileParent = Category;
...
export type TileParentCreateManyInlineInput = {
  /** Connect multiple existing TileParent documents */
  connect?: InputMaybe<Array<TileParentWhereUniqueInput>>;
...
export type TileParentCreateOneInlineInput = {
  /** Connect one existing TileParent document */
  connect?: InputMaybe<TileParentWhereUniqueInput>;
...
export type TileParentUpdateManyInlineInput = {
  /** Connect multiple existing TileParent documents */
  connect?: InputMaybe<Array<TileParentConnectInput>>;
  /** Create and connect multiple TileParent documents */
  create?: InputMaybe<Array<TileParentCreateInput>>;
  /** Delete multiple TileParent documents */
  delete?: InputMaybe<Array<TileParentWhereUniqueInput>>;
  /** Disconnect multiple TileParent documents */
  disconnect?: InputMaybe<Array<TileParentWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing TileParent documents */
  set?: InputMaybe<Array<TileParentWhereUniqueInput>>;
  /** Update multiple TileParent documents */
  update?: InputMaybe<Array<TileParentUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple TileParent documents */
  upsert?: InputMaybe<Array<TileParentUpsertWithNestedWhereUniqueInput>>;
};
...
export type TileParentUpdateOneInlineInput = {
  /** Connect existing TileParent document */
  connect?: InputMaybe<TileParentWhereUniqueInput>;
  /** Create and connect one TileParent document */
  create?: InputMaybe<TileParentCreateInput>;
  /** Delete currently connected TileParent document */
  delete?: InputMaybe<Scalars['Boolean']>;
  /** Disconnect currently connected TileParent document */
  disconnect?: InputMaybe<Scalars['Boolean']>;
...
export type TileUpdateInput = {
  /** Manage document localizations */
  localizations?: InputMaybe<TileUpdateLocalizationsInput>;
  photo?: InputMaybe<AssetUpdateOneInlineInput>;
  /** title input for default locale (pl) */
  title?: InputMaybe<Scalars['String']>;
};

export type TileUpdateLocalizationDataInput = {
  title?: InputMaybe<Scalars['String']>;
};

export type TileUpdateLocalizationInput = {
  data: TileUpdateLocalizationDataInput;
  locale: Locale;
};

export type TileUpdateLocalizationsInput = {
  /** Localizations to create */
  create?: InputMaybe<Array<TileCreateLocalizationInput>>;
  /** Localizations to delete */
  delete?: InputMaybe<Array<Locale>>;
  /** Localizations to update */
  update?: InputMaybe<Array<TileUpdateLocalizationInput>>;
  upsert?: InputMaybe<Array<TileUpsertLocalizationInput>>;
};
...
export type TileUpdateManyInput = {
  /** Optional updates to localizations */
  localizations?: InputMaybe<TileUpdateManyLocalizationsInput>;
  /** title input for default locale (pl) */
  title?: InputMaybe<Scalars['String']>;
};

export type TileUpdateManyLocalizationDataInput = {
  title?: InputMaybe<Scalars['String']>;
};

export type TileUpdateManyLocalizationInput = {
  data: TileUpdateManyLocalizationDataInput;
  locale: Locale;
};

export type TileUpdateManyLocalizationsInput = {
  /** Localizations to update */
  update?: InputMaybe<Array<TileUpdateManyLocalizationInput>>;
};
...
export type TileUpsertLocalizationInput = {
  create: TileCreateLocalizationDataInput;
  locale: Locale;
  update: TileUpdateLocalizationDataInput;
};
...
export type HomePageQuery = { __typename?: 'Query', homePage?: { __typename?: 'HomePage', hero?: { __typename?: 'Hero', titleFirstLine: string, titleSecondLine: string, description?: string | null, ctaButtonLabel: string } | null, aboutSection?: { __typename?: 'Section', title: string, description: string } | null, categories: Array<{ __typename?: 'Category', id: string, title: string, kafelek?: { __typename?: 'Tile', title: string, photo: { __typename?: 'Asset', alt?: string | null, url: string } } | null }>, banner?: { __typename?: 'Banner', text: string, summary: string, button?: string | null } | null } | null };

export type RegulaminQueryVariables = Exact<{ [key: string]: never; }>;


export type RegulaminQuery = { __typename?: 'Query', page?: { __typename?: 'Page', pageTitle: string, sections: Array<{ __typename?: 'AdvancedSection', id: string, title: string, description: { __typename?: 'RichText', markdown: string } }> } | null };


export const HomePageDocument = `
    query HomePage {
  homePage(where: {title: "home"}) {
    hero {
      titleFirstLine
      titleSecondLine
      description
...
useHomePageQuery.fetcher = (client: GraphQLClient, variables?: HomePageQueryVariables, headers?: RequestInit['headers']) => fetcher<HomePageQuery, HomePageQueryVariables>(client, HomePageDocument, variables, headers);
export const RegulaminDocument = `
    query Regulamin {
  page(where: {id: "cl3n5ap7pc33n0eujlbvabwpl"}) {
    pageTitle
    sections {
      id
      title
    ...
    `;
export const useRegulaminQuery = <
      TData = RegulaminQuery,
      TError = unknown
    >(
      client: GraphQLClient,
    ...
    useQuery<RegulaminQuery, TError, TData>(
      ...
      fetcher<RegulaminQuery, RegulaminQueryVariables>(client, RegulaminDocument, variables, headers),
      options
    );

useRegulaminQuery.getKey = (variables?: RegulaminQueryVariables) => variables === undefined ? ['Regulamin'] : ['Regulamin', variables];
;

useRegulaminQuery.fetcher = (client: GraphQLClient, variables?: RegulaminQueryVariables, headers?: RequestInit['headers']) => fetcher<RegulaminQuery, RegulaminQueryVariables>(client, RegulaminDocument, variables, headers);